...
#cancerlist = ["ACC", "BLCA", "BRCA", "LIHC", "LUAD"] # server 2
#cancerlist = ["CESC", "CHOL", "COAD", "LUSC", "MESO"] # server 3
#cancerlist = ["DLBC", "ESCA", "ESCASTAD", "OV", "PAAD"] # server 4
#cancerlist = ["GBM", "HNSC", "KICH", "PCPG", "PRAD"] # server 5
#cancerlist = ["KIRC", "KIRP", "LGG", "READ", "SARC"] # server 6
#cancerlist = ["SKCM", "STAD", "TGCT", "THCA", "THYM"] #server 7
#cancerlist = ["UCEC", "UCS", "UVM"] # server 8
#cancerlist = ["ESCASTAD"]
...
#    print(sample_name1)
    ...
    temporary_line = input_file1.readline() # betavalue임을 명시하는 row를 읽고 폐기
