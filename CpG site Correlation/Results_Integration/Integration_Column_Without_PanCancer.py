# -*- coding: utf-8 -*-
cancerlist = ["PANCANCER", "ACC", "BLCA", "BRCA", "CESC", "CHOL", "COAD", "DLBC", "ESCA", "ESCASTAD", "GBM", "HNSC", "KICH", "KIRC", "KIRP", "LGG", "LIHC", "LUAD", "LUSC", "MESO", "OV", "PAAD", "PCPG", "PRAD", "READ", "SARC", "SKCM", "STAD", "TGCT", "THCA", "THYM", "UCEC", "UCS", "UVM"]
...
output_tumor1 = open("Tumor_Cor_CpGsite_CytAct_pearson.txt", 'w')
output_tumor2 = open("Tumor_Cor_CpGsite_CytAct_spearman.txt", 'w')
...
for i in range(0, len(cancerlist)) :
    input_file1.append(open(cancerlist[i] + ".Tumor_Cor_CpGsite&CytAct_pearson.txt", 'r'))
    input_file2.append(open(cancerlist[i] + ".Tumor_Cor_CpGSite&CytAct_spearman.txt", 'r'))
