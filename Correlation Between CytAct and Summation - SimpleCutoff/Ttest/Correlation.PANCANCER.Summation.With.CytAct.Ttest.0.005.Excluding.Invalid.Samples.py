...
output_file = open("Pvalue." + str(P_value) + ".PANCANCER.Correlation.CytAct.Between.Meaningful.Betavalue.Count.Of.Each.CpGsite.EveryPercentage.Excluding.Invalid.Samples.txt", 'w')
