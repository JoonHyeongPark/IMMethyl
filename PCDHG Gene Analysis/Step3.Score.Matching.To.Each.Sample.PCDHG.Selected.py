...
for i in range(len(cancerlist)) :
    input_tumor = open(file_path + cancerlist[i] + "." + target + ".Methylation.Pattern.tumor.Selected.txt", 'r')
    input_normal = open(file_path + cancerlist[i] + "." + target + ".Methylation.Pattern.normal.Selected.txt", 'r')

    output_tumor = open(file_path + cancerlist[i] + "." + target + ".Score.Matching.Of.Each.Sample.tumor.Selected.txt", 'w')
    output_normal = open(file_path + cancerlist[i] + "." + target + ".Score.Matching.Of.Each.Sample.Normal.Selected.txt", 'w')
